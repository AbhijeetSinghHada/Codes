...
BOOKS = [
    Book(1, "Computer Science Pro", "John Doe",
         "A book about computer science", 4, 2022),
    Book(2, "Computer Science for Dummies", "Jane Doe",
         "A book about computer science", 3, 2008),
